...
namespace com.prodg.photobooth.infrastructure.hardware
{
    public class HardwareV1: IHardware
    {
        ...
        public HardwareV1(ILogger logger)
        {
            ...
            TriggerControl = new RemoteControl(CommandType.Trigger, commandReceiver, commandTransmitter, logger);
            PrintControl = new RemoteControl(CommandType.Print, commandReceiver, commandTransmitter, logger);
            PowerControl = new RemoteControl(CommandType.Power, commandReceiver, commandTransmitter, logger);
        }
